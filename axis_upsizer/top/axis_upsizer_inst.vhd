-----------------------------------------------------------------------
--Filename         : axis_upsizer_inst.vhd
--Description      : Instantiation template for axis_upsizer_top.
...
architecture rtl of axis_upsizer_inst is
  signal aclk : std_logic;
  signal aresetn : std_logic;
  signal s_axis_tdata : std_logic_vector(GC_S_TDATA_WIDTH-1 downto 0);
  ...
  signal m_axis_tdata : std_logic_vector((GC_S_TDATA_WIDTH*GC_RATIO)-1 downto 0);
