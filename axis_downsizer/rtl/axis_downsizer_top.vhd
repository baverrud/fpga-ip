-----------------------------------------------------------------------
--Filename         : axis_downsizer_top.vhd
--Description      : Synthesis wrapper for axis_downsizer, defaulted to the
...
architecture rtl of axis_downsizer_top is
begin
