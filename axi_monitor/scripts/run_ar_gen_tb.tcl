# ============================================================================
# run_ar_gen_tb.tcl - Compile and run axi_ar_gen_tb (comprehensive)
# ============================================================================
...
# ---- Compile testbench ----
vcom -2008 -quiet "$repo_root/axi_monitor/tb/axi_ar_gen_tb.vhd"

# ---- Run ----
vsim -voptargs="+acc" work.axi_ar_gen_tb
run -all
quit -f
