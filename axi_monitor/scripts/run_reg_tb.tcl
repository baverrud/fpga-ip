...
vcom -2008 -quiet "$repo_root/common/rtl/axilite_bfm_pkg.vhd"
vcom -2008 -quiet "$repo_root/axis_fifo/rtl/axis_fifo.vhd"
vcom -2008 -quiet "$repo_root/axilite_io/rtl/axilite_io.vhd"
...
vcom -2008 -quiet "$repo_root/axi_monitor/rtl/axi_monitor_reg.vhd"
...
vcom -2008 -quiet "$repo_root/axi_monitor/tb/axi_monitor_reg_tb.vhd"

# ---- Run ----
vsim -voptargs="+acc" work.axi_monitor_reg_tb
run -all
quit -f
