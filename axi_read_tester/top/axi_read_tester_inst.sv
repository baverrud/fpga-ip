...
module axi_read_tester_inst #(
  ...
  logic mem_aclk;
  logic aresetn;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][15:0] s_axi_awaddr;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][2:0] s_axi_awprot;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_awvalid;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_awready;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][31:0] s_axi_wdata;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][3:0] s_axi_wstrb;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_wvalid;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_wready;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][1:0] s_axi_bresp;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_bvalid;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_bready;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][15:0] s_axi_araddr;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][2:0] s_axi_arprot;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_arvalid;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_arready;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][31:0] s_axi_rdata;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0][1:0] s_axi_rresp;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_rvalid;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] s_axi_rready;
  logic [GC_NUM_TESTERS*GC_NUM_CLIENTS:0] led;
  logic [GC_NUM_TESTERS-1:0][GC_ID_WIDTH-1:0] ar_id;
  logic [GC_NUM_TESTERS-1:0][GC_ADDR_WIDTH-1:0] ar_addr;
  logic [GC_NUM_TESTERS-1:0][GC_NATIVE_ARLEN_WIDTH-1:0] ar_len;
  logic [GC_NUM_TESTERS-1:0][2:0] ar_size;
  logic [GC_NUM_TESTERS-1:0] ar_valid;
  logic [GC_NUM_TESTERS-1:0] ar_ready;
  logic [GC_NUM_TESTERS-1:0][GC_ID_WIDTH-1:0] r_id;
  logic [GC_NUM_TESTERS-1:0][8*GC_NATIVE_DATA_BYTES-1:0] r_data;
  logic [GC_NUM_TESTERS-1:0][1:0] r_resp;
  logic [GC_NUM_TESTERS-1:0] r_last;
  logic [GC_NUM_TESTERS-1:0] r_valid;
  logic [GC_NUM_TESTERS-1:0] r_ready;
