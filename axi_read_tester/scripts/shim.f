...
#
# Used by:
#   run axi_read_tester shim questa      (simulation; Questa 2025.3 for VHDL-2019)
#   run axi_read_tester shim vivado      (synthesis: [rtl] + [top] only)
#
# NOTE: VHDL-2019 mode views require a VHDL-2019 simulator (Questa 2025.3).
#       Compile ALL listed files at 2019 to avoid mixed-standard
...
#   [tb:<name>]  -- Testbench (simulation only, defines top entity)
# ============================================================================
DEFAULT_STD: 2019
DEFAULT_LIB: work
...
[top]
# synthesis wrapper
axi_read_tester/rtl/axi4_read_tester_shim_top.vhd

[tb:default]
top = axi4_read_tester_shim_tb
# AXI4-Lite BFM testbench
axi_read_tester/tb/axi4_read_tester_shim_tb.vhd
